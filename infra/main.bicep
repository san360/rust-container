...
var hostingPlanName = '${abbrs.webSitesFunctions}${resourceToken}'
var applicationInsightsName = '${abbrs.insightsComponents}${resourceToken}'
var storageAccountName = '${abbrs.storageStorageAccounts}${resourceToken}'


module appinsight 'appinsight/appinsight.bicep' = {
...
module stg 'storage/storage.bicep' = {
...
module function 'functionapp/function.bicep' =  {
  ...
  params:{
   ...
   storageAccount: stg.outputs.storageAccount
